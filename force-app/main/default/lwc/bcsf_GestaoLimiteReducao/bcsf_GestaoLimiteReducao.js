...
import reduzirLimite from '@salesforce/apex/GestaoLimiteController.reduzirLimite';
import getExtratoCompacto from '@salesforce/apex/BCSF_CLS_CalloutFaturasController.getExtratoCompacto';

import { CurrentPageReference } from 'lightning/navigation';
import { CloseActionScreenEvent } from 'lightning/actions';

export default class BCSF_GestaoLimiteReducao extends LightningElement {
    ...
    handleValorLimiteDesejado(event) {
        ...
        if(this.valorLimiteDesejado == this.limiteTotal){
            ...
            this.msgErro = 'Valor informado é superior ao limite atual';
        } else if(this.valorLimiteDesejado < (this.saldoDevedor)){
            this.msgErro = 'Valor não deve ser inferior ao débito do cliente';
        } else {
            this.msgErro = '';
        }
    }
    ...
    async getExtratoFaturaCompacto() {
        try {
            ...
            if (result.statusResponse == 'OK') {
                ...
                this.saldoDevedor = result.saldoDevedorNestaData;
                this.saldoDevedorFormatado = formatarValor(result.saldoDevedorNestaData);
