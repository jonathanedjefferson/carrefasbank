...
import listagemTipoEventos from '@salesforce/apex/BCSF_ControleOperacoesController.listagemTipoEventos';
import consultarOperacoes from '@salesforce/apex/BCSF_ControleOperacoesController.consultarOperacoes';
import getAccount from '@salesforce/apex/BCSF_ControleOperacoesController.getAccount';

export default class BCSF_ControleOperacoes extends LightningElement {
    spinner;
    telaHome = true;
    telaListagem = false;
    modalDetalhes = false;
